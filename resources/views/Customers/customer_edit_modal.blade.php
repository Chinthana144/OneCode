<div class="modal" tabindex="-1" role="dialog" id="customer_edit_modal">
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('customer.update') }}" method="post">
        ...
        <div class="modal-body">
            ...
            <select name="cmb_edit_camp" class="form-select" id="cmb_edit_camp">
            ...
            <select name="cmb_edit_customer_type" class="form-select" id="cmb_edit_customer_type">
            ...
            <input type="text" name="edit_phone" id="edit_phone" class="form-control" placeholder="0#########" required>
            ...
            <input type="password" name="edit_password" id="edit_password" class="form-control bi bi-eye-slash" placeholder="password"
                required>

            <label for="" class="form-label mt-2">Customer Status</label>
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="chk_edit_customer_stat" name="chk_edit_customer_stat"
                    checked>
                <label class="form-check-label" for="chk_edit_customer_stat">Active
                    input
                </label>
            </div>
        </div>
